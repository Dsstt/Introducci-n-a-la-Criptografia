...
1. Generación de Claves (Miller-Rabin)
...
4. Cifrado Híbrido de Archivos (Imágenes)
...
Genera primos y calcula claves.

Cifra y descifra un mensaje de texto corto.

Cifra una imagen local Unal.png y guarda los resultados binarios (imagen_cifrada.bin).

Descifra los archivos y recupera la imagen original como imagen_descifrada.png.
